...
class About(tk.Frame):
	def __init__(self,App,parent):
		...
		self.label_Username = tk.Label(self.main_frame,text='This is a storage app so you can check in how many stocks',font = ('Arial',18,"bold"),bg ='black',fg='white')
		self.label_Username.pack(fill='both')
		self.label2 = tk.Label(self.main_frame, text='and the price list on the items that you want and also change them.',font = ('Arial',18,"bold"),bg ='black',fg='white')
